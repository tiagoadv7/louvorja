// Créditos do LouvorJA — mesma lista mantida no fork violin-app
// (src/config/Contributors.ts), portada aqui sem os tipos TS e sem os
// ícones de "papel" (Web/Electron/Delphi/API), que dependem de um
// config/Icons.js que este projeto não tem — description vira só texto.
...

  {
    ...
    contributors: [
      ...
      },
      {
        ...
        email: "gabrieldutragv@hotmail.com",
